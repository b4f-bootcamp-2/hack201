...
router.post("/", async (req, res) => {
    ...
    if(type === "Vet appointment"||type === "Cleaning expense" || type === "Establishemnt Management" ) await updateGoods(user.UserName, prev.CurrentFood, prev.CurrentWater, prev.Savings - Number(value), prev.CurrentMedicine)
